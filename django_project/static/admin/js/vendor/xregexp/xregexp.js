...
module.exports = function(XRegExp) {
     ...
     * available to provide data for Unicode categories, src, blocks, and properties.
     *
     * @requires XRegExp
     */
...
module.exports = function(XRegExp) {
     ...
     * #18 RL1.2 additionally requires support for Unicode src and general categories. These are
...
module.exports = function(XRegExp) {
    ...
    /**
     * Adds support for all Unicode src. E.g., `\p{Latin}`. Token names are case insensitive,
...
require('./addons/unicode-src')(XRegExp);
